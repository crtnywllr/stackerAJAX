...
var getAnswerers = function (answerers) {
    //alert("I have just activated the getAnswerer function");
...
var showAnswerers = function (answerers) {
    ...
    var userName = result.find('.name a');
    userName.attr('href', answerers.user.link);
    userName.text(answerers.user.display_name);
    //Display profile image
    var image = "<img src='" + answerers.user.profile_image + "' alt='" + answerers.user.display_name + "'>";
    $(userName).append(image);
